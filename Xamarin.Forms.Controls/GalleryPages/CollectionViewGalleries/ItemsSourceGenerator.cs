...
namespace Xamarin.Forms.Controls.GalleryPages.CollectionViewGalleries
{
	...
	internal class CarouselItemsSourceGenerator : ContentView
	{
		public event EventHandler<NotifyCollectionChangedEventArgs> CollectionChanged;
		readonly CarouselView _cv;
		...
		public CarouselItemsSourceGenerator(CarouselView cv, int initialItems = 1000,
